...
const Card = ({ year, title, subtitle, description, tags }: CardProps) => {
  return (
    <li className="mb-12">
      <div className="group rounded-lg hover:!opacity-100 border-transparent hover:border-accent-800 border-2 group-hover/list:opacity-50 grid sm:grid-cols-10 p-4 transition-colors duration-100 cursor-pointer">
        {year && <div className="sm:col-span-3 mt-1 text-sm">{year}</div>}
        <div className={year !== "" ? "sm:col-span-7" : "sm:col-span-10"}>
